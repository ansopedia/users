...
export const errorMap = {
  ...
  [ErrorTypeEnum.enum.ROLE_ALREADY_EXISTS]: {
    ...
    body: {
      code: "duplicate_role",
      message: "Role already exists. Please choose a different role.",
    },
  },
  ...
  [ErrorTypeEnum.enum.PERMISSION_ALREADY_EXISTS]: {
    ...
    body: {
      ...
      message: "Permission already exists. Please choose a different permission.",
    },
  },
  ...
  [ErrorTypeEnum.enum.ROLE_PERMISSION_ALREADY_EXISTS]: {
    ...
    body: {
      ...
      message: "Role and permission combination already exists",
    },
  },
  [ErrorTypeEnum.enum.USER_ROLE_ALREADY_EXISTS]: {
    ...
    body: {
      ...
      message: "User and role combination already exists",
    },
  },
